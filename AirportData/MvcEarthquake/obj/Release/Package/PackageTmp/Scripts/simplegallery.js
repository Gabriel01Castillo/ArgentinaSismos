...
var simpleGallery_navpanel={
	loadinggif: 'Content/images/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'Content/images/left.gif', 'Content/images/play.gif', 'Content/images/right.gif', 'Content/images/pause.gif'], //nav panel images (in that order)
...
simpleGallery.routines={
	...
	getSlideHTML:function(imgelement){
		...
		layerHTML+='<img width="250" height="400" src="'+imgelement[0]+'" style="border-width:0" />'
